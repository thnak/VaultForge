...
public partial class LandPage : ComponentBase
{
    protected override void OnInitialized()
    {
        ...
        if (ContentId != null)
        {
            ...
            articleModel = AdvertisementService.Get(ContentId) ?? AdvertisementService.Get(ContentId, CultureInfo.CurrentUICulture.Name);
        }
        else
        {
            articleModel = AdvertisementService.Get("Index", CultureInfo.CurrentUICulture.Name);
        }
