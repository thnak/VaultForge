...
public interface IMathService
{
    ...
    [Description("subtracts the second number from the first. for example 1 - 1 = 0")]
    ...
    [Description("multiplies two numbers. for example 1 * 5 = 5")]
    ...
    [Description("divides the first number by the second. It raises an error if the denominator is zero or inputs are invalid. . for example 10 / 1 = 1")]
    ...
    [Description("pow two number. for example 5 ^ 5 = 25")]
    ...
    [Description("sorts a list of numbers and returns the sorted list.")]
